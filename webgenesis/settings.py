...
DATABASES = {
    'default': {
        ...
        'NAME': 'webgenesis',   # Or path to database file if using sqlite3.
        'USER': 'webgenesis',                      # Not used with sqlite3.
        'PASSWORD': 'webgenesis',                  # Not used with sqlite3.
